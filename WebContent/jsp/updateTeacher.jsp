...
<body>
<div class="alert alert-info"><b class="tip"></b>教师管理<b class="tip"></b>修改教师信息</div>
<form action="/JaoWuSyst/teacher/updateTeacher.do" method="post"  enctype="multipart/form-data" onsubmit="return stopSub()">
    <table class="table table-striped table-bordered table-condensed" id="mytable">
        <tr>
            <td>姓名：</td>
            <td >
                <input type="text" name="name" id="name" onblur="titileOnblur()" value="${teacher.name}"/></td>
        </tr>
        <tr>
            <td>密码：</td>
            <td><input id="pwd" type="password" name="pwd" value="${teacher.pwd}"/></td>
        </tr>
        <tr>
        	<td>性别：</td>
            <td>
        ...
        <tr>
            <td>教龄：</td>
            <td><input type="text" name="Seniority" value="${teacher.seniority}"/></td>
        </tr>
        <tr>
        	<td>学科</td>
            <td>
        ...
        <tr>
            ...
            <div class="input-append">
              	<input class="span2" id="date1" size="16" type="text" name="birthday" value="${teacher.birthday}"><span class="add-on"><i class="icon-calendar"></i></span>
            </div>
        	</td>
        </tr>
        <tr>
        	...
        	<td>
            <div class="input-append">
              	<input class="span2" id="date2" size="16" type="text" name="startTime" value="${teacher.startTime}"/><span class="add-on"><i class="icon-calendar"></i></span>
            </div>
        	</td>
        </tr>
        <tr>
        ...
        <tr>
         <tr>
            <td>档案文件: </td>
            <td ><input type="text" name="archiveFile" value="${teacher.archiveFile}" readonly="true"/>
